    ...
    >
      ...
      <View style={styles.section}>
        <Text
          style={[
            styles.sectionTitle,
            { color: theme.colors.text, fontSize: theme.fontSizes.h2 },
          ]}
        >
          Account
        </Text>
          ...
          <View style={styles.profileRow}>
            ...
            <View style={styles.profileInfo}>
              <Text
                style={[
                  styles.profileEmail,
                  { color: theme.colors.text, fontSize: theme.fontSizes.body },
                ]}
              >
      ...
      <View style={styles.section}>
            ...
            >
              <Text
                style={[
                  ...
                  {
                    color:
                      themeMode === "system" ? "#FFFFFF" : theme.colors.text,
                    fontSize: theme.fontSizes.small,
                  },
                ]}
              >
        ...
        <View
          style={[
            styles.card,
            { backgroundColor: theme.colors.card, marginTop: 12 },
          ]}
        >
          <Text
            style={[
            ...
            >
              <Text
                style={[
                  ...
                  {
                    color:
                      fontSize === "medium" ? "#FFFFFF" : theme.colors.text,
                    fontSize: 14,
                  },
                ]}
              >
